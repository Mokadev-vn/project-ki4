			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-12">
					<div class="fj_post home3">
						<div class="details">
							...
							<p class="mb0">Posted 23 August by <a class="text-thm3" href="#">Wiggle CRC</a></p>
							<ul class="featurej_post">
				...
				<div class="col-sm-6 col-lg-12">
					<div class="fj_post home3">
						<div class="details">
							...
							<p>Posted 23 August by <a class="text-thm3" href="#">Parkside Recruitment - Uxbridge Finance</a></p>
							<ul class="featurej_post">
				...
				<div class="col-sm-6 col-lg-12">
					<div class="fj_post home3">
						<div class="details">
							...
							<p>Yesterday <a class="text-thm3" href="#">NonStop Recruitment Ltd</a></p>
							<ul class="featurej_post">
								<li class="list-inline-item"><span class="flaticon-location-pin"></span> <a href="#">Bothell, WA, USA</a></li>
								<li class="list-inline-item"><span class="flaticon-price pl20"></span> <a href="#">$13.00 - $18.00 per hour</a></li>
							</ul>
				...
				<div class="col-sm-6 col-lg-12">
					<div class="fj_post home3 bbt">
						<div class="details">
							<div class="thumb fn-smd">
								<img class="img-fluid" src="images/partners/13.jpg" alt="13.jpg">
							</div>
							<h4>UX/UI Designer</h4>
							<p>Yesterday <a class="text-thm3" href="#">NonStop Recruitment Ltd</a></p>
							<ul class="featurej_post">
					...
					<div class="company_reg_slider">
						<div class="item">
							<div class="company_grid text-center">
								<div class="thumb"><img class="img-fluid" src="images/partners/5.jpg" alt="5.jpg"></div>
								<div class="details">
									<h4>The Trainnig</h4>
						...
						<div class="item">
							<div class="company_grid text-center">
								<div class="thumb"><img class="img-fluid" src="images/partners/6.jpg" alt="6.jpg"></div>
								<div class="details">
									<h4>Mencap</h4>
									<p><span class="flaticon-location-pin pr10"></span> Bothell, WA, USA</p>
									<a class="btn btn-blue" href="#">4 Open Position</a>
						...
						<div class="item">
							<div class="company_grid text-center">
								<div class="thumb"><img class="img-fluid" src="images/partners/7.jpg" alt="7.jpg"></div>
								<div class="details">
						...
						<div class="item">
							<div class="company_grid text-center">
								<div class="thumb"><img class="img-fluid" src="images/partners/8.jpg" alt="8.jpg"></div>
								<div class="details">
									<h4>Shiseido</h4>
									<p><span class="flaticon-location-pin pr10"></span> Bothell, WA, USA</p>
									<a class="btn btn-blue" href="#">4 Open Position</a>
